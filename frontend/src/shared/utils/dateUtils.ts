 ...
 */
export const getWeekRangeDates = (offset: number): { start: Date; end: Date } => {
 ...
 */
export const getWeekRangeStrings = (offset: number): { start: string; end: string } => {
 ...
 */
export const getMonthRangeDates = (offset: number): { start: Date; end: Date } => {
  const today = new Date();
 ...
 */
export const getMonthRangeStrings = (offset: number): { start: string; end: string } => {
