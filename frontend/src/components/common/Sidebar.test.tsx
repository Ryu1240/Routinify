...
vi.mock('@mantine/core', () => ({
  Box: ({ children, ...props }: any) => <div data-testid="sidebar" {...props}>{children}</div>,
  NavLink: ({ label, description, leftSection, active, onClick, ...props }: any) => (
    <button data-testid="nav-link" onClick={onClick} data-active={active} {...props}>
      {leftSection}
